...
#run QUAST
metaquast.py $WORKDIR/03_CONTIGS/final.contigs.fa \
--threads 20 --circos --glimmer --rna-finding \
--blast-db /proj/DECOMB/source//quast/silva_db/silva_db \
-1 $WORKDIR/01_QC/R1.fastq.gz \
-2 $WORKDIR/01_QC/R2.fastq.gz \
-o $WORKDIR/03_CONTIGS/megahit
